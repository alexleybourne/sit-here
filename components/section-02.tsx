...
import Features from '@/public/images/employee-cards.png';
import Image from 'next/image';
import QuoteAuthor from '@/public/images/adam.jpeg';
            ...
            <div className='relative max-w-xl mx-auto md:max-w-none text-center md:text-left'>
              ...
              <div className='md:max-w-lg'>
                ...
                <h2
                  ...
                  data-aos-delay='100'
                >
                  Revolutionise your office space with AI-driven seating plans!
                </h2>
                <p
                  ...
                  data-aos-delay='200'
                >
                  Unlock the power of collaboration with Intelligent seating
                  solutions.
                </p>
                ...
                >
                  ...
                  <div>
                    <blockquote className='text-slate-400 m-0'>
                      “Our office transformed into a hub of collaboration! The
                      AI-driven seating plans have boosted productivity and
                      fostered dynamic teamwork like never before. Our employees
                      love the optimized seating arrangements that maximize
                      interaction and innovation. It's a game-changer!” - Adam
                    </blockquote>
                  </div>
                </div>
              </div>
