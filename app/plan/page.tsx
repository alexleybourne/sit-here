...
export default function Dashboard() {
  ...
  const Button = ({ text, svg }: ButtonProp): JSX.Element => (
    <Link href='/dashboard'>
      {' '}
      <label className='h-fit flex items-center gap-1 justify-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-500 hover:text-white'>
        {svg}
